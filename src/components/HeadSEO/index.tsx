...
export default function HeadSEO({ title }: IHeadSEOProps) {
  return (
    <Head>
      <title>{title || "colecional.digital - crie seu nft via pix e use no instagram"}</title>
      <meta
        name="description"
      ...
      <meta name="keywords" content="nft, colecionavel, digital, cr" />
      <meta name="author" content="colecionavel.digital team" />
